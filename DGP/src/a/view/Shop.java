...
public class Shop extends JFrame {
	...
	public Shop() {
       ...
       contentPane.setBackground(Color.green);
		...
		label_2.setBounds(110, 297, 109, 33);
		panel.add(label_2);
		
		JLabel label_3 = new JLabel("皮肤简介");
		label_3.setBounds(321, 297, 109, 33);
		panel.add(label_3);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon("shop/s2.png"));
		lblNewLabel_3.setBounds(230, 87, 66, 137);
		panel.add(lblNewLabel_3);
		
		JLabel label_4 = new JLabel("角色皮肤：");
		label_4.setForeground(Color.CYAN);
		label_4.setBounds(33, 22, 82, 15);
		panel.add(label_4);
		
		JLabel label_5 = new JLabel("箱子皮肤：");
		label_5.setForeground(Color.CYAN);
		label_5.setBounds(33, 262, 82, 15);
		panel.add(label_5);
		...
		button_2.setBounds(102, 439, 82, 39);
		panel.add(button_2);
		
		JButton button_3 = new JButton("购买");
		button_3.setForeground(Color.RED);
		button_3.setBounds(321, 439, 83, 39);
		panel.add(button_3);
		...
		label_8.setBounds(110, 354, 74, 39);
		panel.add(label_8);
		
		JLabel label_9 = new JLabel("所需积分：");
		label_9.setBounds(321, 354, 83, 39);
		panel.add(label_9);
	}
